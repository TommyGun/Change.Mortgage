    ...
    <div className="relative bg-white">
          ...
          <main className="mx-auto max-w-7xl px-4 pt-10 pb-16 sm:pt-12 sm:px-6 md:pt-16 lg:pt-20 lg:px-8 xl:pt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                ...
                <span className="block text-blue-600">Mortgage Business</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Revolutionize your mortgage operations with cutting-edge technology and innovative solutions that drive growth and efficiency.
              </p>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img
          ...
          alt="Professional mortgage broker meeting with clients"
        />
      </div>
    </div>
  );
